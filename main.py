...
def main(args):
    ...
    if(not args.is_eval_only):
        ...
        utilities = np.zeros((args.batch_size))
...
# python main.py btcvae_celeba_best_ld100 -x best_celeba --latent-dim 100
# python main.py btcvae_celeba_best_ld10  -x best_celeba --latent-dim 10
